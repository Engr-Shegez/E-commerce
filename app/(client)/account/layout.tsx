        ...
        <div className="max-w-5xl mx-auto">
          <Card className="mb-5">
            <CardContent className="p-6 flex flex-col md:flex-row md:items-center justify-between">
              <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 md:justify-between w-full">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <SignOutButton>
                      <button className="text-base font-semibold underline underline-offset-4 decoration-[1px] hover:text-tech_bg_dark_red hoverEffect mt-2 md:mt-0">
                        Logout
                      </button>
                    </SignOutButton>
                  </div>
